...
export default function About() {
    return (
        <div className="container accordion accordion-flush my-5" id="accordionFlushExample">
            <div className="accordion-item">
                ...
                <div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body">
                        <p>Launched in 2007, News24 (News 24 Broadcast India Limited) has caught the imagination of the urban as well as rural viewer in a very short span of time. Incisive and creative, News 24 targets the global Indian with news that is credible, true and fast. With its tagline, Think First, News24 believes in the mantra of inclusiveness and targets to empower its viewers. Over the years, News24 has attained the image of a channel that is constructive, solution seeking, engaging and relevant to the Aam Aadmi.</p>
                        <p>News 24 Broadcast India Limited is part of the BAG Network which is promoted by B.A.G. Films & Media Limited. B.A.G. Films & Media Limited is a company, incorporated in 1993 and listed with NSE/BSE/DSE. A leading 360 degree integrated Media and Entertainment brand in India, B.A.G . Films & Media Limited has diversified in the business of Television and Film Production, Media Education and Training, New Media and Convergence.</p>
            ...
            <div className="accordion-item">
                ...
                <div id="flush-collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body">Anurradha Prasad, CMD and Editor-in Chief, News 24 Broadcast India Limited Anurradha Prasad is a name that needs no introduction in the Indian media industry today. From her humble start to her present day success, she stands as a dynamic personality who exemplifies that believing in oneself can fulfil any aspiration and realize the seemingly most distant and farfetched dream.</div>
                </div>
            </div>
            <div className="accordion-item">
                <h2 className="accordion-header">
                ...
                <div id="flush-collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body">
                        ...
                        <p>Anurradha launched her own umbrella brand Broadcast 24 under which she would launch channels and create content of the highest quality for audiences. First to come alive under the brand was ‘News 24’; a 24-hour News channel that gained impressive viewership across India in weeks of it coming on air. A 24-hour entertainment channel E 24 was then launched. Under the brand is also broadcast Dhamaal 24- a 24-hour radio network on air now at 10 stations across the country. With a web network called B.A.G Convergence, Dhamaal 24, News 24, E 24, Anurradha has led B.A.G Films & Media Ltd to become a 360 media company associated with quality content dissemination across media and networks.</p>
